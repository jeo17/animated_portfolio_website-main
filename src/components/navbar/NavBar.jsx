      ...
      <nav className=" container m-auto flex items-center justify-between">
        <div data-aos="fade-down" className="logo">
          <Link
            ...
            to="/"
            className="text-3xl font-bold sm:text-3xl full-name"
          >
            Abdeldjalil Dahmani.
          </Link>
        </div>
        ...
        >
          ...
          >
            <HiMenu size={25} className="HiMenu"/>
          </button>
          ...
          >
            ...
            {navItems.map((item) => (
              ...
              >
                <a
                  ...
                  href={`#${item.name}`}
                  className={`nav-bar-items uppercase cursor-pointer text-black hover:text-yellow-600 font-bold ${
            ...
            <a
              ...
              className="nav-bar-hire bg-black text-[1rem] text-white px-8 py-2 rounded-lg font-bold hover:text-yellow-400 md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
            >
              HIRE ME
            </a>
          </ul>
